...
<!--          <a href="#" class="linkedin"><i class="bx bxl-linkedin"></i></a>-->
  ...
  <section id="home" class="d-flex flex-column justify-content-center align-items-center">
    <div class="hero-container" data-aos="fade-in">
      <h1>Prinses Rizada</h1>
      <p><b>Adjudanten Barbudo & Pelliroja</b></p>
    </div>
  </section><!-- End Hero -->
  ...
  <main id="main">
      ...
      <div class="container">
        ...
        <div class="row">
          <div class="col-lg-4" data-aos="fade-right">
            <img src="{{asset("img/rizada.jpg")}}" class="img-fluid" alt="">
          </div>
    ...
    <!-- ======= Progrmama Section ======= -->
    <section id="programma" class="facts">
      <div class="container">
    ...
    <!-- ======= Bonte avond Section ======= -->
    <section id="bonteavond" class="skills section-bg">
      <div class="container">
    ...
    </section><!-- End Bonte avond Section -->

    <!-- ======= Programma Section ======= -->
    <section id="optocht" class="resume">
      <div class="container">
    ...
    <!-- ======= Steunend lid Section ======= -->
    <section id="steunendlid" class="portfolio section-bg">
      <div class="container">
    ...
    </section><!-- End Steunend lid Section -->
